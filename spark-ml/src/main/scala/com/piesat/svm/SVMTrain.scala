...
object SVMTrain {
  def main(args: Array[String]): Unit = {
    ...
    /** *****=======5.通过决策树建立模型============= *******/
    val rfc: LinearSVC = new LinearSVC().setLabelCol("lable").setFeaturesCol("scaledFeatures")
    ...
    /** *****=======13.模型保存============= *******/
    val rfcBestModel: LinearSVCModel = bestModel.asInstanceOf[PipelineModel].stages(3).asInstanceOf[LinearSVCModel]
    //加载模型
